...
slurm_parser.add_argument(
    ...
    default="output/slurm/error/{rule}/{wildcards}.e" if "output/slurm/error/{rule}/{wildcards}.e" else None)
slurm_parser.add_argument(
...
slurm_parser.add_argument(
    ...
    default="output/slurm/output/{rule}/{wildcards}.o" if "output/slurm/output/{rule}/{wildcards}.o" else None)
slurm_parser.add_argument(
...
if arg_dict["partition"] is None:
    if not "IACT":
        ...
        arg_dict["partition"] = "IACT"

# Set default account
if arg_dict["account"] is None:
    if "cr517" != "":
        arg_dict["account"] = "cr517"
